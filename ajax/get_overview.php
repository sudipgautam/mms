...
<div class="row">
	<div id="breadcrumb" class="col-xs-12">
		<a href="#overview" class="show-sidebar">
...
<div id="dashboard-header" class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 pull-right">
		<div class="row">
			<div class="col-xs-2 color-green">
				<div class="sparkline-dashboard" >
					<i class="fa fa-user fa-4x"></i>
				</div>
				<div class="sparkline-dashboard-info">
					<i class="fa fa-usd"></i>756
					<span >You Paid </span>
				</div>
			</div>
			<div class="col-xs-2 color-blue" >
				<div class="sparkline-dashboard " >
					<i class="fa fa-users fa-4x"></i>
				</div>
				<div class="sparkline-dashboard-info">
					<i class="fa fa-usd"></i>245
					<span >Friends Owe you</span>
				</div>
			</div>
			<div class="col-xs-2 color-grey">
				<div class="sparkline-dashboard " >
					<i class="fa fa-pie-chart fa-4x"></i>
				</div>
				<div class="sparkline-dashboard-info">
					<i class="fa fa-usd"></i>107
					<span>Net</span>
				</div>
			</div>
		</div>
...
<div class="row-fluid">
	<div id="dashboard_links" class="col-xs-12 col-sm-2 pull-right">
		<ul class="nav nav-pills nav-stacked">
			...
			<li><a href="#" class="tab-link" id="clients">Add Bills</a></li>
			<li><a href="#" class="tab-link" id="clients">Friends</a></li>
			<li><a href="#" class="tab-link" id="servers">Payment</a></li>
			<li><a href="#" class="tab-link" id="planning">Statistics</a></li>
		</ul>
	</div>
		...
		<div id="dashboard-overview" class="row" style="visibility: visible; position: relative;">
			<div id="ow-marketplace" class="col-sm-12 col-md-6">
				...
				<table id="ticker-table" class="table m-table table-bordered table-hover table-heading">
					...
					<tbody>
						<tr>
							<td class="m-ticker"><b>Sudip  </b><span>Gautam</span></td>
				...
				<div id="ow-summary" class="row">
					<div class="col-xs-12">
						...
						<div class="row">
							<div class="col-xs-12">
								<div class="row">
									<div class="col-xs-6">Total Amount<b>1245634</b></div>
									<div class="col-xs-6">You Paid<b>227</b></div>
								</div>
								<div class="row">
