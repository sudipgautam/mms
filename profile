...
<html lang="en">
  <head>
    ...
    <meta name="keyword" content="Dashboard, Bootstrap, mymoneysplit, money, split">

    <title>Dashboard - mymoneysplit.com</title>
  ...
  <section id="container" >
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="index.html" class="logo"><b>MyMoneySplit</b></a>
            <!--logo end-->
